    ...
    Array.from(isApexSeries).forEach(function (e) {
        ...
        t["data-chart-series"] &&
            ((isApexSeriesData.series =
                t["data-chart-series"].value.toString()),
            (e = getChartColorsArray(t.id.value.toString())),
            (e = {
            ...
            new ApexCharts(
                document.querySelector("#" + t.id.value.toString()),
                e
            ).render());
    });
var options,
    chart,
    donutchartProjectsStatusColors = getChartColorsArray("prjects-status");
