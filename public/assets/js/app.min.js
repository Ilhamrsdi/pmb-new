        ...
        Array.from(n).forEach(function (e, t) {
            t + 1 === a && (s = e),
                ...
                t + 1 === n.length &&
                    ...
                    s.insertAdjacentHTML(
                        "afterend",
                        '<li class="nav-item">\t\t\t\t\t\t<a class="nav-link" href="#sidebarlainnya" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarlainnya">\t\t\t\t\t\t\t<i class="ri-briefcase-2-line"></i> Lainnya\t\t\t\t\t\t</a>\t\t\t\t\t\t<div class="collapse menu-dropdown" id="sidebarlainnya"><ul class="nav nav-sm flex-column">' +
                            o +
                            "</ul></div>\t\t\t\t\t</li>"
                    );
        });
