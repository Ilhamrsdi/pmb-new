      ...
      <div class="dropdown d-inline-block">
        ...
        <div class="dropdown-menu dropdown-menu-end pt-0">
          ...
          <a class="dropdown-item" href="apps-chat"><i
              ...
              class="align-middle">@lang('translation.Messages')</span></a>
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="topnav-form">
                    ...
                    <a href="form-validation" class="dropdown-item"
                      data-key="t-form-validation">@lang('translation.Form_Validation')</a>
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="topnav-table">
                    ...
                    <a href="tables-advanced" class="dropdown-item"
                      data-key="t-advanced-tables">@lang('translation.Advanced_Table')</a>
                  </div>
                </div>
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="topnav-apex-charts">
                        ...
                        <a href="charts-candlestick" class="dropdown-item"
                          data-key="t-candlestick">@lang('translation.Candlestick')</a>
